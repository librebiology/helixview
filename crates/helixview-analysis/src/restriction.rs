...
pub static ENZYMES: &[RestrictionEnzyme] = &[
    RestrictionEnzyme {
        name: "EcoRI",
        recognition: b"GAATTC",
        color_idx: 0,
    },
    RestrictionEnzyme {
        name: "BamHI",
        recognition: b"GGATCC",
        color_idx: 1,
    },
    RestrictionEnzyme {
        name: "HindIII",
        recognition: b"AAGCTT",
        color_idx: 2,
    },
    RestrictionEnzyme {
        name: "XbaI",
        recognition: b"TCTAGA",
        color_idx: 3,
    },
    RestrictionEnzyme {
        name: "SalI",
        recognition: b"GTCGAC",
        color_idx: 4,
    },
    RestrictionEnzyme {
        name: "KpnI",
        recognition: b"GGTACC",
        color_idx: 5,
    },
    RestrictionEnzyme {
        name: "SacI",
        recognition: b"GAGCTC",
        color_idx: 6,
    },
    RestrictionEnzyme {
        name: "EcoRV",
        recognition: b"GATATC",
        color_idx: 7,
    },
    RestrictionEnzyme {
        name: "NcoI",
        recognition: b"CCATGG",
        color_idx: 8,
    },
    RestrictionEnzyme {
        name: "NdeI",
        recognition: b"CATATG",
        color_idx: 9,
    },
    RestrictionEnzyme {
        name: "BglII",
        recognition: b"AGATCT",
        color_idx: 10,
    },
    RestrictionEnzyme {
        name: "ClaI",
        recognition: b"ATCGAT",
        color_idx: 11,
    },
    RestrictionEnzyme {
        name: "NheI",
        recognition: b"GCTAGC",
        color_idx: 12,
    },
    RestrictionEnzyme {
        name: "SpeI",
        recognition: b"ACTAGT",
        color_idx: 13,
    },
    RestrictionEnzyme {
        name: "XhoI",
        recognition: b"CTCGAG",
        color_idx: 14,
    },
    RestrictionEnzyme {
        name: "PstI",
        recognition: b"CTGCAG",
        color_idx: 15,
    },
    RestrictionEnzyme {
        name: "SphI",
        recognition: b"GCATGC",
        color_idx: 16,
    },
    RestrictionEnzyme {
        name: "SmaI",
        recognition: b"CCCGGG",
        color_idx: 17,
    },
    RestrictionEnzyme {
        name: "MluI",
        recognition: b"ACGCGT",
        color_idx: 18,
    },
    RestrictionEnzyme {
        name: "AvrII",
        recognition: b"CCTAGG",
        color_idx: 19,
    },
];
