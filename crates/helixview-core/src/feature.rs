...
impl Default for FeatureType {
    fn default() -> Self { Self::MiscFeature }
}
...
impl FeatureType {
    ...
    pub fn default_color(&self) -> Color {
        match self {
            ...
            Self::MiscRNA | Self::SnRNA | Self::ScRNA
                                         => Color::from_u8( 80, 180,  80),
            ...
            Self::RepeatRegion | Self::RepeatUnit
                                         => Color::from_u8(210, 200,  50), // yellow
            Self::Source                 => Color::TRANSPARENT,
            Self::StemLoop               => Color::from_u8(200, 100, 100),
            Self::Terminator | Self::PromotionalRegion
                                         => Color::from_u8(150,  80, 200),
